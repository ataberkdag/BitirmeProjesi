...
def main():
    ...
    try:
        ...
        print("Hata, classifications.txt adlı dosya bulunamadı!\n")
        os.system("pause")
        return
    ...
    try:
        ...
        print("Hata, flattened_images.txt adlı dosya bulunamadı!\n")
        os.system("pause")
        return
    ...
    imgTestingNumbers = cv2.imread("kontrol.jpg")
